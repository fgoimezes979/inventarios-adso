...
Location.hasMany(Entry, { foreignKey: "location_id", as: "entries" });
Entry.belongsTo(Location, { foreignKey: "location_id", as: "location" });
...
// ------------------------
// Product ↔ Location ↔ LocationProduct (Muchos a muchos con stock)
// ------------------------
...
Location.hasMany(LocationProduct, { foreignKey: "location_id", as: "location_products" });
Product.hasMany(LocationProduct, { foreignKey: "product_id", as: "product_locations" });

LocationProduct.belongsTo(Location, { foreignKey: "location_id", as: "location" });
LocationProduct.belongsTo(Product, { foreignKey: "product_id", as: "product" });

// ------------------------
// Out ↔ Product ↔ Location
// ------------------------
...
Out.belongsTo(Order, { foreignKey: "order_id", as: "order" });
...
Tx.belongsTo(Order, { foreignKey: "order_id", as: "order" });
